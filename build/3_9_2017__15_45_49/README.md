...
* STDOUT:
Updating f3a5857..daf5e09
Fast-forward
 game/gfx/tileset_rabbibisden.png | Bin 0 -> 5156 bytes
 1 file changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 game/gfx/tileset_rabbibisden.png

* STDERR:
From github.com:cegonse/rabibbi-game
   f3a5857..daf5e09  master     -> origin/master
...
Resource: TILESET rabbibi_tiles_def "./gfx/rabbibi_tileset.png" NONE
--> executing plugin TILESET...
