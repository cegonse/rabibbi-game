...
* STDOUT:
Updating 5fcece1..d47ac61
Fast-forward
 game/gfx/shadows/shadow_drop_small.png | Bin 0 -> 166 bytes
 1 file changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 game/gfx/shadows/shadow_drop_small.png

* STDERR:
From github.com:cegonse/rabibbi-game
   5fcece1..d47ac61  master     -> origin/master
